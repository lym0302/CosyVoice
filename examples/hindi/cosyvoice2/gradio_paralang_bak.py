...
wav_entries = load_wavscp_with_text(playlist_file)[:6]
...
with gr.Blocks() as demo:
    ...
    with gr.Row():
        ...
        start_input = gr.Number(label="Start ID", value=0, precision=0)
        end_input = gr.Number(label="End ID", value=1000000, precision=0)
