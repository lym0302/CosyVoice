...
def main():
    ...
    parser.add_argument("-m", "--model_path", type=str, required=True, help="Path to trained CosyVoice2 model")
    parser.add_argument("--spk_name", type=str, default="26172091", help="Speaker name")
    parser.add_argument("-t", "--test_file", type=str, default="datas/tttest/test.jsonl", help="Test JSONL file")
