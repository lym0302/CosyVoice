...
exp_dir=exps/flow_pitch5000
model=flow

torchrun --nnodes=1 --nproc_per_node=4 \
	--rdzv_id=2986 --rdzv_backend="c10d" --rdzv_endpoint="localhost:2234" \
	cosyvoice/bin/train_flow_pitch.py \
	...
	> logs/train_flow_pitch5000.log 2>&1
