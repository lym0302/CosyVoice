...
# data_dir=/data/liangyunming/tts_20250618/CosyVoice/examples/hindi/cosyvoice2/filelists/yoyo_new3spk
# save_dir=datas/yoyo_new3spk
# data_name=yoyo_20250904_2spks
data_name=$1
data_dir=filelists/$data_name
save_dir=datas/$data_name
