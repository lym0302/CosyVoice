...
root_dir = "/data/liangyunming/tts_20250618/CosyVoice/examples/hindi/cosyvoice2/output/yoyo_sft_zz_epoch0_test300_rename"
...
def get_sample(idx, username):
    ...
    if 0 <= idx < total_num:
        ...
        return None, "", "", "", "", "", 0, 0, "All audio files have been evaluated."


def save_and_next(ref_text, unclear, missing, extra, user_text, acc, real, idx, username):
    if idx >= total_num:
        return None, "", "", "", "", "", 0, 0, "All audio files have been evaluated.", idx
    ...
    if next_idx >= total_num:
        return None, "", "", "", "", "", 0, 0, "All audio files have been evaluated.", next_idx
...
def save_and_prev(ref_text, unclear, missing, extra, user_text, acc, real, idx, username):
    ...
    prev_idx = idx - 1
    if prev_idx < 0:
        return None, "", "", "", "", "", 0, 0, "This is the first audio sample.", prev_idx
...
with gr.Blocks() as demo:
    ...
    btn_prev.click(save_and_prev, inputs=[ref_text, unclear_text, missing_text, extra_text, user_text, mos_accuracy, mos_realness, idx_state, name_input],
    ...
    btn_next.click(save_and_next, inputs=[ref_text, unclear_text, missing_text, extra_text, user_text, mos_accuracy, mos_realness, idx_state, name_input],
                   outputs=[audio_player, ref_text, unclear_text, missing_text, extra_text, user_text, mos_accuracy, mos_realness, progress_text, idx_state])
