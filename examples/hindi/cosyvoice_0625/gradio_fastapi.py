...
wav_file = "/data/liangyunming/tts_20250618/CosyVoice/examples/hindi/cosyvoice_0625/output/output_exp_yoyo_sft/wav.scp"
...
with gr.Blocks() as demo:
    ...
    btn_next.click(save_and_next, inputs=[text_input, mos_accuracy, mos_realness, idx_state],
                   outputs=[audio_player, text_input, mos_accuracy, mos_realness, progress_text, idx_state])
    btn_export.click(export_csv, inputs=None, outputs=export_status)
