...
def process_audio_asr(audio_root, asr_root, output_file, target_lang, max_dur=30):
    total_count = 0
    empty_count = 0
    miss_count = 0
    json_error_count = 0
    ...
    with open(output_file, 'w', encoding='utf-8') as fout:
        for spk in tqdm(os.listdir(audio_root)):
...
def main():
    ...
    process_audio_asr(args.audio_dir, args.asr_dir, args.output_file, args.lang)
